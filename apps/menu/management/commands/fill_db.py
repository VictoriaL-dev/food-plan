...
class Command(BaseCommand):
    help = 'Наполнение базы данных 16 тестовыми блюдами (Dish) по 4 на каждое меню'
    ...
    def handle(self, *args, **options):
        ...
        raw_dishes = [
            # ================= CLASSIC MENU (4 блюда) =================
            {
                ...
                'calories': 320, 'meal_type': 'breakfast', 'menu_code': 'classic',
            ...
            },
            {
                ...
                'calories': 480, 'meal_type': 'lunch', 'menu_code': 'classic',
            ...
            },
            {
                ...
                'calories': 380, 'meal_type': 'dinner', 'menu_code': 'classic',
            ...
            # ================= LOW CARB MENU (4 блюда) =================
            {
                ...
                'calories': 290, 'meal_type': 'breakfast', 'menu_code': 'low_carb',
            ...
            },
            {
                ...
                'calories': 550, 'meal_type': 'lunch', 'menu_code': 'low_carb',
            ...
            },
            {
                ...
                'calories': 340, 'meal_type': 'dinner', 'menu_code': 'low_carb',
            ...
            },
            {
                ...
                'calories': 90, 'meal_type': 'dessert', 'menu_code': 'low_carb',
                'ingredients': [('Ягоды (малина/клубника)', '100г'), ('Желатин', '10г'), ('Стевия', 'по вкусу')]
            },

            # ================= VEGETARIAN MENU (4 блюда) =================
            {
                ...
                'calories': 310, 'meal_type': 'breakfast', 'menu_code': 'vegetarian',
            ...
            },
            {
                ...
                'calories': 360, 'meal_type': 'lunch', 'menu_code': 'vegetarian',
            ...
            },
            {
                ...
                'calories': 290, 'meal_type': 'dinner', 'menu_code': 'vegetarian',
            ...
            },
            {
                ...
                'calories': 210, 'meal_type': 'dessert', 'menu_code': 'vegetarian',
            ...
            # ================= KETO MENU (4 блюда) =================
            {
                ...
                'calories': 410, 'meal_type': 'breakfast', 'menu_code': 'keto',
            ...
            },
            {
                ...
                'calories': 680, 'meal_type': 'lunch', 'menu_code': 'keto',
            ...
            },
            {
                ...
                'calories': 510, 'menu_code': 'keto', 'meal_type': 'dinner',
            ...
            },
            {
                ...
                'calories': 260, 'meal_type': 'dessert', 'menu_code': 'keto',
        ...
        for d_data in raw_dishes:
            recipe = Recipe.objects.create(
                ...
                meal_type=d_data['meal_type'],
                menu_type=menus[d_data['menu_code']]
            )

            for ing_name, ing_amount in d_data['ingredients']:
        ...
        self.stdout.write(self.style.SUCCESS(f'База успешно наполнена! Добавлено {len(raw_dishes)} блюд.'))